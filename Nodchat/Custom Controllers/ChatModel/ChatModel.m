...
- (void)addSpecifiedItem:(NSDictionary *)dic
{
    ...
    [dataDic setObject:@"Justin Rice" forKey:@"strName"];
...
- (NSDictionary *)getDic
{
    ...
    switch (randomNum) {
        case 0:// text
            ...
            break;
        case 1:// picture
            [dictionary setObject:[UIImage imageNamed:@"img_sample01.png"] forKey:@"picture"];
            break;
//            case 2:// audio
...
//                break;
    ...
    [dictionary setObject:@"Mark McBright" forKey:@"strName"];
