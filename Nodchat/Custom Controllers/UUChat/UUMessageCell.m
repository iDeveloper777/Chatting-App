...
//        [headImageBackView addSubview:self.btnHeadImage];
        ...
        self.txtName = [[UITextView alloc] init];
        self.txtName.textColor = [UIColor grayColor];
        self.txtName.textAlignment = NSTextAlignmentCenter;
        self.txtName.font = ChatTimeFont;
        self.txtName.scrollEnabled = NO;
        self.txtName.editable = NO;
...
//        [self.btnHeadImage setBackgroundImage:[UIImage imageNamed:@"CsabaToth.jpg"] forState:UIControlStateNormal];
//    }else{
////        [self.btnHeadImage setBackgroundImageForState:UIControlStateNormal withURL:[NSURL URLWithString:message.strIcon]];
//        [self.btnHeadImage setBackgroundImage:[UIImage imageNamed:@"Mark.png"] forState:UIControlStateNormal];
//    }
...
//    }
    ...
    self.txtName.text = message.strName;
    if (messageFrame.nameF.origin.x > 160){
        self.txtName.frame = CGRectMake(messageFrame.nameF.origin.x, messageFrame.nameF.origin.y + 3, 60, messageFrame.nameF.size.height);
        self.txtName.textAlignment = NSTextAlignmentCenter;
    }else{
        self.txtName.frame = CGRectMake(messageFrame.nameF.origin.x, messageFrame.nameF.origin.y + 3, 60, messageFrame.nameF.size.height);
        self.txtName.textAlignment = NSTextAlignmentCenter;
